<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminlogin.aspx.cs" Inherits="Home.adminlogin" %>
			...
			<h2>LOG-IN</h2>
             <table>
                 ...
                 <tr>
                  ...
                  <tr>
                      <td>
                          <asp:Button ID="Button3" runat="server" Text="LOG-IN" Height="40px" Width="280px" OnClick="Button3_Click" />
                      </td>
                  </tr>
              </table>
                 </div>
